...
INSERT IGNORE INTO stage_instance(id,project_id,stage_code,stage_name,stage_order,status,gate_status,gate_message) VALUES
  (10000,1000,'START','项目立项',1,'COMPLETED','PASSED',NULL),(10001,1000,'REQUIREMENT','调研与启动',2,'COMPLETED','PASSED',NULL),(10002,1000,'CUSTOM_DEV','方案与计划',3,'ACTIVE','BLOCKED','存在 P0 技术风险'),(10003,1000,'GO_LIVE','开发与测试',4,'PENDING','READY',NULL),(10004,1000,'TRIAL_HANDOVER','验证与发布',5,'PENDING','READY',NULL),(10005,1000,'STANDARDIZATION','验收与结项',6,'PENDING','READY',NULL),(10006,1000,'CLOSE','过程跟进',7,'PENDING','READY',NULL),
  (10010,1001,'START','项目立项',1,'COMPLETED','PASSED',NULL),(10011,1001,'REQUIREMENT','调研与启动',2,'COMPLETED','PASSED',NULL),(10012,1001,'CUSTOM_DEV','方案与计划',3,'COMPLETED','PASSED',NULL),(10013,1001,'GO_LIVE','开发与测试',4,'ACTIVE','WARNING','待完成切换演练'),(10014,1001,'TRIAL_HANDOVER','验证与发布',5,'PENDING','READY',NULL),(10015,1001,'STANDARDIZATION','验收与结项',6,'PENDING','READY',NULL),(10016,1001,'CLOSE','过程跟进',7,'PENDING','READY',NULL),
  (10020,1002,'START','项目立项',1,'COMPLETED','PASSED',NULL),(10021,1002,'REQUIREMENT','调研与启动',2,'ACTIVE','READY',NULL),(10022,1002,'CUSTOM_DEV','方案与计划',3,'PENDING','READY',NULL),(10023,1002,'GO_LIVE','开发与测试',4,'PENDING','READY',NULL),(10024,1002,'TRIAL_HANDOVER','验证与发布',5,'PENDING','READY',NULL),(10025,1002,'STANDARDIZATION','验收与结项',6,'PENDING','READY',NULL),(10026,1002,'CLOSE','过程跟进',7,'PENDING','READY',NULL),
  (10030,1003,'START','项目立项',1,'COMPLETED','PASSED',NULL),(10031,1003,'REQUIREMENT','调研与启动',2,'COMPLETED','PASSED',NULL),(10032,1003,'CUSTOM_DEV','方案与计划',3,'COMPLETED','PASSED',NULL),(10033,1003,'GO_LIVE','开发与测试',4,'COMPLETED','PASSED',NULL),(10034,1003,'TRIAL_HANDOVER','验证与发布',5,'ACTIVE','WARNING','待客户验收'),(10035,1003,'STANDARDIZATION','验收与结项',6,'PENDING','READY',NULL),(10036,1003,'CLOSE','过程跟进',7,'PENDING','READY',NULL),
  (10040,1004,'START','项目立项',1,'COMPLETED','PASSED',NULL),(10041,1004,'REQUIREMENT','调研与启动',2,'COMPLETED','PASSED',NULL),(10042,1004,'CUSTOM_DEV','方案与计划',3,'COMPLETED','PASSED',NULL),(10043,1004,'GO_LIVE','开发与测试',4,'COMPLETED','PASSED',NULL),(10044,1004,'TRIAL_HANDOVER','验证与发布',5,'COMPLETED','PASSED',NULL),(10045,1004,'STANDARDIZATION','验收与结项',6,'ACTIVE','READY',NULL),(10046,1004,'CLOSE','过程跟进',7,'PENDING','READY',NULL),
  (10050,1005,'START','项目立项',1,'COMPLETED','PASSED',NULL),(10051,1005,'REQUIREMENT','调研与启动',2,'COMPLETED','PASSED',NULL),(10052,1005,'CUSTOM_DEV','方案与计划',3,'COMPLETED','PASSED',NULL),(10053,1005,'GO_LIVE','开发与测试',4,'COMPLETED','PASSED',NULL),(10054,1005,'TRIAL_HANDOVER','验证与发布',5,'COMPLETED','PASSED',NULL),(10055,1005,'STANDARDIZATION','验收与结项',6,'COMPLETED','PASSED',NULL),(10056,1005,'CLOSE','过程跟进',7,'COMPLETED','PASSED',NULL);
