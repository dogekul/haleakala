...
async function createProject(
  ...
  const projectNameInput = drawer.getByLabel('项目名称')
  await expect(projectNameInput).toHaveValue('华东银行 - 企业财务云 V5.0 实施项目')
  await projectNameInput.clear()
  await projectNameInput.pressSequentially(name)
